		...
		if(!empty($product_files)){
			...
			if($total >0){
				...
				$products = array(
					...
					'space_preference'=>$data['space_preference'],
					'no_of_days'=>$data['no_of_days'],
					'no_of_functions'=>$data['no_of_functions'],
					'airbrush'=>$data['airbrush'],
				...
				if(!empty($product_id)){
					//move images from temperorary directory to product directory
